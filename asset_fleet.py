...
# Assets excluded from the fleet entirely -- they will not be simulated,
# ingested, scored, or returned by any endpoint (/predictions, /sensor-status,
# /admin/*, etc).
EXCLUDED_ASSET_IDS = {"A033", "A036"}
